...
def update_company_settings(payload: CompanySettings) -> dict:
    return service.update_company(payload.model_dump())
...
def get_settings_history() -> list[dict]:
    return service.list_settings_history()
